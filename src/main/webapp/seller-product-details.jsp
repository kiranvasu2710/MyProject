		...
		<div class="banner_inner d-flex align-items-center">
			<div class="container">
				<div
					...
					<div class="page_link">
						<a href="index.jsp">Home</a> <a href="seller-product-details.jsp">Product
							Details</a>
					</div>
				</div>
			</div>
	...
	<div class="product_image_area">
		<div class="container">
			<div class="row s_product_inner">
							...
							<div class="carousel-inner">
								<div class="carousel-item active">
									<img class="d-block w-40"
										src="product_img/<%=p.getProduct_img()%>"
										alt="First slide" />
								</div>
							</div>
						</div>
				...
				<div class="col-lg-65 offset-lg-1">
					<div class="s_product_text">
						...
						<p>
							<a href="seller-product-edit.jsp?pid=<%=p.getPid()%>"><input type="button" value="EDIT" class="btn btn-success"></a>
