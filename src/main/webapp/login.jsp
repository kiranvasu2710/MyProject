...
<script>
	...
	function searchInfo() {
		...
		var url = "AjaxSearch1.jsp?val=" + name;
		try {
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-12 mb-4 mb-lg-0">
          <form class="form-contact contact_form" action="UserController" method="post" name="login">
            <div class="row">
              <div class="col-12">
              <div class="col-6">
            ...
            <div class="form-group mt-lg-3">
              <button type="submit" class="main_btn" name="action" value="login">Login</button>
              <a href="forgot-password.jsp"><button type="button" class="main_btn">Forgot Password</button></a>
            </div>
          </form>
        </div>
          </div>
