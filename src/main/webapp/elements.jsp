	...
	<div class="whole-wrap">
		<div class="container">
			...
			<div class="section-top-border text-right">
				...
				<div class="row">
					<div class="col-md-9">
						<p class="text-right">Over time, even the most sophisticated, memory packed computer can begin to run slow if we dont do something to prevent
						...
						<p class="text-right">Before we discuss all of the things that could be affecting your PCs performance, lets talk a little about what symptoms</p>
					</div>
					<div class="col-md-3">
						<img src="img/elements/d.jpg" alt="" class="img-fluid">
					</div>
